...
echo -e "\033[1;93m└──────────────────────────────────────────┘\033[0m"
echo -e "\033[1;93m┌──────────────────────────────────────────┐\033[0m"
echo -e "\033[1;93m│  ${grenbo}01.${NC} \033[0;36mSSH OVPN MANAGER${NC} ${grenbo}08.${NC} \033[0;36mPORT VPS INFO${NC}"
echo -e "\033[1;93m│  ${grenbo}02.${NC} \033[0;36mVMESS MANAGER${NC}    ${grenbo}09.${NC} \033[0;36mLOAD VPS INFO${NC}"
echo -e "\033[1;93m│  ${grenbo}03.${NC} \033[0;36mVLESS MANAGER${NC}    ${grenbo}10.${NC} \033[0;36mSPEEDTEST${NC}"
echo -e "\033[1;93m│  ${grenbo}04.${NC} \033[0;36mTROJAN MANAGER${NC}   ${grenbo}11.${NC} \033[0;36mCHANGE DOMAIN${NC}"
echo -e "\033[1;93m│  ${grenbo}05.${NC} \033[0;36mSHDWSK MANAGER${NC}   ${grenbo}12.${NC} \033[0;36mCHANGE BANNER${NC}"
echo -e "\033[1;93m│  ${grenbo}06.${NC} \033[0;36mRUNNING SYSTEM${NC}   ${grenbo}13.${NC} \033[0;36mRESTART SERVICE${NC}"
echo -e "\033[1;93m│  ${grenbo}07.${NC} \033[0;36mBACKUP & RESTORE${NC} ${grenbo}14.${NC} \033[0;36mOTHER SETTING${NC}"
echo -e "\033[1;93m└──────────────────────────────────────────┘\033[0m"
echo -e ""
