...
echo -e "${BICyan}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e ""
echo -e " ${BICyan}[${BIWhite}01${BICyan}]${y} •${NC} ${BIWhite}SSHWS [ᴍᴇɴᴜ]       $NC  ${BICyan}[${BIWhite}12${BICyan}]${RED} • ${NC}${BIWhite}RUNNING $NC"
echo -e " ${BICyan}[${BIWhite}02${BICyan}]${y} •${NC} ${BIWhite}VMESS [ᴍᴇɴᴜ]       $NC  ${BICyan}[${BIWhite}13${BICyan}]${RED} • ${NC}${BIWhite}VPS INFO $NC"
echo -e " ${BICyan}[${BIWhite}03${BICyan}]${y} •${NC} ${BIWhite}VLESS [ᴍᴇɴᴜ]       $NC  ${BICyan}[${BIWhite}14${BICyan}]${RED} • ${NC}${BIWhite}CREATE SLOW$NC"
echo -e " ${BICyan}[${BIWhite}04${BICyan}]${y} •${NC} ${BIWhite}TROJAN [ᴍᴇɴᴜ]      $NC  ${BICyan}[${BIWhite}15${BICyan}]${RED} • ${NC}${BIWhite}BOT BACKUP  $NC"
echo -e " ${BICyan}[${BIWhite}05${BICyan}]${y} •${NC} ${BIWhite}S-SOCK [ᴍᴇɴᴜ]      $NC  ${BICyan}[${BIWhite}16${BICyan}]${RED} • ${NC}${BIWhite}REBOOT $NC"
echo -e " ${BICyan}[${BIWhite}06${BICyan}]${y} •${NC} ${BIWhite}TRIAL [ᴍᴇɴᴜ]       $NC  ${BICyan}[${BIWhite}17${BICyan}]${RED} • ${NC}${BIWhite}RESTART $NC"
echo -e " ${BICyan}[${BIWhite}07${BICyan}]${y} •${NC} ${BIWhite}UPDATE [ᴍᴇɴᴜ]      $NC  ${BICyan}[${BIWhite}18${BICyan}]${RED} • ${NC}${BIWhite}DOMAIN $NC"
