...
echo -e "${BICyan}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e ""
echo -e " ${BICyan}[${BIWhite}01${BICyan}]${y} •${NC} ${BIWhite}SSHWS MENU         $NC  ${BICyan}[${BIWhite}12${BICyan}]${RED} • ${NC}${BIWhite}BANNER CHANGE $NC"
...
echo -e " ${BICyan}[${BIWhite}05${BICyan}]${y} •${NC} ${BIWhite}SSOCK MENU         $NC  ${BICyan}[${BIWhite}16${BICyan}]${RED} • ${NC}${BIWhite}SPEEDTEST $NC"
...
echo -e " ${BICyan}[${BIWhite}10${BICyan}]${y} •${NC} ${BIWhite}GEN-SSL CERTV      $NC  ${BICyan}[${BIWhite}21${BICyan}]${RED} • ${NC}${BIWhite}CLEAR CACHE  $NC"
echo -e " ${BICyan}[${BIWhite}11${BICyan}]${y} •${NC} ${BIWhite}ADD HOST           $NC  ${BICyan}[${BIWhite}22${BICyan}]${RED} • ${NC}${BIWhite}BOT NOTIF $NC"  
echo -e " ${BICyan}[${BIWhite}11${BICyan}]${y} •${NC} ${BIWhite}[X] Ketik x to exit$NC  ${BICyan}[${BIWhite}22${BICyan}]${RED} • ${NC}${BIWhite}UPDATE SCRIPT $NC"  
echo -e " ${RED}"
echo -e "${BICyan}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo " "
