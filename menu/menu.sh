...
echo -e "\033[1;93m       └───────────────────────────┘\033[0m"
echo -e "${COLOR1}    NGINX ${NC}: $resngx"" ${COLOR1}  XRAY ${NC}: $resv2r"" ${COLOR1} TROJAN ${NC}: $resv2r"
echo -e "${COLOR1}    STUNNEL ${NC}: $ressh" "${COLOR1} DROPBEAR ${NC}: $resdbr" "${COLOR1} UDP-CUSTOM ${NC}: $resv2r"    
echo -e "\033[1;93m┌──────────────────────────────────────────┐\033[0m"
echo -e "\033[1;93m│  ${grenbo}1.${NC} \\E[40;1;37mSSH OVPN MANAGER${NC} ${grenbo}4.${NC} \\E[40;1;37mTROJAN MANAGER${NC}"
echo -e "\033[1;93m│  ${grenbo}2.${NC} \\E[40;1;37mVMESS MANAGER${NC}    ${grenbo}5.${NC} \\E[40;1;37mSHDWSK MANAGER${NC}"
