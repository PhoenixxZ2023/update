...
echo -e " ${BICyan}[${BIWhite}09${BICyan}]${y} •${NC} ${BIWhite}UPDATE ALL         $NC  ${BICyan}[${BIWhite}20${BICyan}]${RED} • ${NC}${BIWhite}CERT SSL   $NC"
echo -e " ${BICyan}[${BIWhite}10${BICyan}]${y} •${NC} ${BIWhite}ABOUT SCRIPT       $NC  ${BICyan}[${BIWhite}21${BICyan}]${RED} • ${NC}${BIWhite}CLEAR CACHE  $NC"
