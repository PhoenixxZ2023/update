...
echo -e " ${BICyan}[${BIWhite}07${BICyan}]${y} •${NC} ${BIWhite}SETTING            $NC  ${BICyan}[${BIWhite}18${BICyan}]${RED} • ${NC}${BIWhite}DOMAIN $NC"
echo -e " ${BICyan}[${BIWhite}08${BICyan}]${y} •${NC} ${BIWhite}AUTO REBOOT        $NC  ${BICyan}[${BIWhite}19${BICyan}]${RED} • ${NC}${BIWhite}NS DOMAIN  $NC"
echo -e " ${BICyan}[${BIWhite}09${BICyan}]${y} •${NC} ${BIWhite}DELETE ACCOUNT     $NC  ${BICyan}[${BIWhite}20${BICyan}]${RED} • ${NC}${BIWhite}CERT SSL   $NC"
echo -e " ${BICyan}[${BIWhite}10${BICyan}]${y} •${NC} ${BIWhite}UPDATE SCRIPT      $NC  ${BICyan}[${BIWhite}21${BICyan}]${RED} • ${NC}${BIWhite}CLEAR CACHE  $NC"
echo -e " ${BICyan}[${BIWhite}11${BICyan}]${y} •${NC} ${BIWhite}INFO PORT VPS      $NC  ${BICyan}[${BIWhite}22${BICyan}]${RED} • ${NC}${BIWhite}BOT NOTIF $NC"  
echo -e " ${RED}"
echo -e "${BICyan}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo " "
